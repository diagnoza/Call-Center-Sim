...
public class Source implements CProcess
{
	...
	/** Mean interarrival times for different hours */
	private double[] meanArrTimes;
...
//	/**
//	*	Constructor, creates objects
//	*        Interarrival times are exponentially distributed with non stationary mean
//	*	@param q	The receiver of the products
//	*	@param l	The eventlist that is requested to construct events
//	*	@param n	Name of object
//	*/
//	public Source(ProductAcceptor q,CEventList l,String n, double [] meanArrTimes)
//	{
//		list = l;
//		queue = q;
//		name = n;
//		meanArrTime=33;
//		// put first event in list for initialization
//		list.add(this,0,drawNonStationaryExponential(meanArrTime, meanArrTimes[0])); //target,type,time
//	}
		...
		if(meanArrTime>0)
		{
			...
			if(this.name.equals("ConsumerSource")) {
				...
				throw new IllegalArgumentException("The name of the source has to be" +
													" \"ConsumerSource\" or \"CorporateSource\"");
